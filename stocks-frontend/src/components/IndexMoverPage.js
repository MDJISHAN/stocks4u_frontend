...
const IndexMoverPage = ({ onBack, onNiftyItClick }) => {
  ...
  <div className="index-mover-container new-index-page">
    ...
    <div className="date-bar">
      <div className="date-selector">Start Date<br /><span className="purple-badge"> 17 Feb, 2025</span></div>
      <div className="date-selector">End Date<br /><span className="purple-badge">17 Feb, 2025</span></div>
      <div className="net-position">Net Position<br />
      <span className="green-badge">+532 Pts</span></div>
      <div className="last-updated">Last Updated at <strong>10:05 AM</strong></div>
    </div>
